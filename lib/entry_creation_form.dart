...
class _EntryCreationFormState extends State<EntryCreationForm> {
  ...
  void initState() {
    ...
    if (_isEditMode) {
      ...
      // Keep old remote URLs if user doesn't remove them
  ...
  Future<void> _saveEntry() async {
    ...
    // 3) Create or update the JournalEntry
    ...
    // Pop back to detail page (or home) which re-reads from provider
      ...
      children: [
        ...
        SizedBox(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              // Custom Chewie widget that takes a local File
        ...
        if (_oldVideoURLs.isNotEmpty)
          SizedBox(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                // Custom Chewie widget that takes a URL
